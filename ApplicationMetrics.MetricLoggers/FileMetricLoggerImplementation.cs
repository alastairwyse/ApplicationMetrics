...
namespace ApplicationMetrics.MetricLoggers
{
    ...
    class FileMetricLoggerImplementation : MetricLoggerBuffer, IDisposable
    {
        ...
        public FileMetricLoggerImplementation(char separatorCharacter, IBufferProcessingStrategy bufferProcessingStrategy, bool intervalMetricChecking, IStreamWriter streamWriter, IDateTime dateTime, IStopwatch stopWatch, IExceptionHandler exceptionHandler)
