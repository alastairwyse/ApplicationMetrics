...
namespace ApplicationMetrics.MetricLoggers
{
    ...
    abstract class MetricLoggerStorer : MetricLoggerBuffer
    {
        ...
        protected MetricLoggerStorer(IBufferProcessingStrategy bufferProcessingStrategy, bool intervalMetricChecking, IDateTime dateTime, IStopwatch stopWatch, IExceptionHandler exceptionHandler)
