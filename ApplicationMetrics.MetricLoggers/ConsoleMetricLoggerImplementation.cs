...
namespace ApplicationMetrics.MetricLoggers
{
    ...
    class ConsoleMetricLoggerImplementation : MetricAggregateLogger
    {
        ...
        /// <summary>
        /// Initialises a new instance of the ApplicationMetrics.MetricLoggers.ConsoleMetricLoggerImplementation class.
        /// </summary>
        ...
        /// <summary>
        /// Initialises a new instance of the ApplicationMetrics.MetricLoggers.ConsoleMetricLoggerImplementation class.  Note this is an additional constructor to facilitate unit tests, and should not be used to instantiate the class under normal conditions.
        /// </summary>
        /// <param name="bufferProcessingStrategy">Object which implements a processing strategy for the buffers (queues).</param>
        /// <param name="intervalMetricChecking">Specifies whether an exception should be thrown if the correct order of interval metric logging is not followed (e.g. End() method called before Begin()).</param>
        ...
        public ConsoleMetricLoggerImplementation(IBufferProcessingStrategy bufferProcessingStrategy, bool intervalMetricChecking, IConsole console, IDateTime dateTime, IStopwatch stopWatch, IExceptionHandler exceptionHandler)
